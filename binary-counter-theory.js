...
const theoryDict = {
    en: {
        ...
        coinStep3: '<strong>1 coin</strong> is stored on the newly set bit as a reserve for its future 1→0 carry flip.',
    ...
    cz: {
        ...
        coinStep3: '<strong>1 mince</strong> z dotace aktuální operace je uložena k nově nastavenému bitu jako rezerva na jeho budoucí přepnutí 1→0 přenosem.',
