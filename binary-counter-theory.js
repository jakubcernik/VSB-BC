...
const theoryDict = {
    en: {
        ...
        coinStep2: '<strong>1 coin</strong> pays for flipping the 0→1 bit (the actual new work).',
        coinStep3: '<strong>1 coin</strong> is saved on the newly set bit to pay for flipping it back 1→0 later (via carry).',
        coinStep4: 'Each carry flip (1→0) is paid by the <strong>1 saved coin</strong> already sitting on that bit — no extra charge needed.',
        accountingMath:  'Every 1-bit carries exactly 1 saved coin. When carry flips it to 0, that coin pays for the flip. No deficit ever occurs.',
    ...
    cz: {
        ...
        coinStep2: '<strong>1 mince</strong> zaplatí přepnutí bitu 0→1 (skutečná nová práce).',
        coinStep3: '<strong>1 mince</strong> je ušetřena na nově nastaveném bitu jako záloha na jeho budoucí přepnutí 1→0 přenosem.',
        coinStep4: 'Každé přepnutí přenosem (1→0) je zaplaceno <strong>1 ušetřenou mincí</strong> uloženou na daném bitu — žádný další poplatek není potřeba.',
        accountingMath:  'Každý bit 1 nese přesně 1 ušetřenou minci. Když přenos přepne bit na 0, tato mince za přepnutí zaplatí. Nikdy nedojde k deficitu.',
