...
const dict = {
    en: {
        ...
        resizeNeededNow:  (projected, threshold) => `Projected load ${projected} exceeds threshold ${threshold} — resize + rehash is required now to keep insert cost amortized O(1).`,
        resizeNotNeeded:  (projected, threshold) => `Projected load ${projected} is within threshold ${threshold} — no resize before this insert, amortized reserve stays for future rehash.`,
    ...
    cz: {
        ...
        resizeNeededNow:  (projected, threshold) => `Očekávané zaplnění ${projected} překračuje limit ${threshold} — je potřeba resize + rehash, aby cena vložení zůstala amortizovaně O(1).`,
        resizeNotNeeded:  (projected, threshold) => `Očekávané zaplnění ${projected} je v limitu ${threshold} — před tímto vložením není resize potřeba a amortizovaná rezerva zůstává na budoucí rehash.`,
